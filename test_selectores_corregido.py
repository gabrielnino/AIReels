#!/usr/bin/env python3
"""
Prueba de selectores para Instagram - SOLO DIAGNÓSTICO (CORREGIDO)
...
print("=" * 80)
print("🔍 PRUEBA DE SELECTORES - Instagram UI Diagnosis (CORREGIDO)")
print("=" * 80)
...
async def probar_selectores():
    ...
    try:
        ...
        page = browser_service.page  # ¡PROPIEDAD, no método!
        ...
        screenshot_path = "instagram_landing_page_diagnostico.png"
...
async def main():
    ...
    if success:
        ...
        print("\n📄 ARCHIVOS GENERADOS:")
        print("   • instagram_landing_page_diagnostico.png - Screenshot de la página")
