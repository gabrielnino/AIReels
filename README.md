...
|-----|--------|----------|--------------|
| Arquitecto | Alex Technical Architect | [Pendiente] | Arquitectura de sistemas, Python, IA |
| Main Developer | Sam Lead Developer | [Pendiente] | Python, FastAPI, Computer Vision |
